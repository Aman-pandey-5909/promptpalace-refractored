...
import { getPromptsController, createPromptController, editPromptController, deletePromptController, toggleLikeController } from "../controllers/prompt.controller";
